        ...
        const result = await booking.findAll({
            ...
            where: {
                [Op.or]: {
                    ...
                    check_in_date: { [Op.like]: `%${keyword}%` },
                    check_out_date: { [Op.like]: `%${keyword}%` },
...
const findPemesananByCheckInDate = async (req, res) => {
    try {
...
const findByFilterDate = async (req, res) => {
